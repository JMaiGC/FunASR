...
from funasr.export.models.e2e_vad_semantic import SemanticVADModel as SemanticVADModel_export
from funasr.export.models.e2e_vad_semantic import SemanticVADModelEncoder as SemanticVADModelEncoder_export
from funasr.export.models.e2e_vad_semantic import SemanticVADModelStrideConv as SemanticVADModelStrideConv_export
...
def get_model(model, export_config=None):
    ...
    elif isinstance(model, SemanticVADModel) or isinstance(model, SemanticVADModelChunkOpt):
        if export_config["model_name"] == "model_encoder":
            return SemanticVADModelEncoder_export(model, **export_config)
        elif export_config["model_name"] == "model_stride_conv":
            return SemanticVADModelStrideConv_export(model, **export_config)
        else:
            return SemanticVADModel_export(model, **export_config)
